...
import unb.banco.cliente.RepositorioClientes;
import unb.banco.cliente.RepositorioClientesArray;
import unb.banco.conta.CadastroContas;
import unb.banco.conta.Conta;
import unb.banco.conta.ListaContas;
import unb.banco.conta.RepositorioContas;
import unb.banco.conta.RepositorioContasArray;
...
public class Fachada {
	...
	public int renderJuros(String numero, double taxa) {
		...
		return contas.renderJuros(numero, taxa);
	}
